...
| :--- | :---: | :---: | :---: |
| **LS + Linear Interpolation (LI Benchmark)** | `0.499399` | `-1.69 dB` | `0.677811` |
| **LS + MMSE Benchmark (Perfect Correlation)** | `0.497783` | `-14.36 dB` | `0.036605` |
| **H_ls_attention (ONNX Attention Model with LS Sequence Input)** | `0.498627` | `-6.83 dB` | `0.207654` |
