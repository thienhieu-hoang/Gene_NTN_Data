...
| :--- | :---: | :---: | :---: |
| **LS + Linear Interpolation (LI Benchmark)** | `0.498251` | `-6.44 dB` | `0.226762` |
| **LS + MMSE Benchmark (Perfect Correlation)** | `0.496376` | `-17.09 dB` | `0.019525` |
| **H_ls_attention (ONNX Attention Model with LS Sequence Input)** | `0.497746` | `-8.46 dB` | `0.142686` |
