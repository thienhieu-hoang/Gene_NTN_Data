...
| :--- | :---: | :---: | :---: |
| **LS + Linear Interpolation (LI Benchmark)** | `0.496998` | `-10.78 dB` | `0.083560` |
| **LS + MMSE Benchmark (Perfect Correlation)** | `0.495347` | `-18.53 dB` | `0.014039` |
| **H_ls_attention (ONNX Attention Model with LS Sequence Input)** | `0.496539` | `-9.58 dB` | `0.110171` |
