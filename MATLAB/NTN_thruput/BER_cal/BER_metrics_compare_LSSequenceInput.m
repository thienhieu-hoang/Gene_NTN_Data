...
SYSTEM GEOMETRY & SIMULATION FLOW:
  ...
  4. Results & Reporting:
     ...
     - Exports MAT performance data, complex 2D channel matrices, vector PDF heatmaps for Sample 1,
       network architecture visualization graph, and markdown summary report in 'inference_result/' folder structure.
========================================================================================
%}
...
if ~isempty(net_ls)
    save_vars = [save_vars, {'ber_ls_atten', 'nmse_ls_atten'}];
end
