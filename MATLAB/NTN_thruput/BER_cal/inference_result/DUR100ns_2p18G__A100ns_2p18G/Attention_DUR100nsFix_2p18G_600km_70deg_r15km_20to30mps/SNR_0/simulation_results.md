...
| :--- | :---: | :---: | :---: |
| **LS + Linear Interpolation (LI Benchmark)** | `0.500384` | `3.29 dB` | `2.131690` |
| **LS + MMSE Benchmark (Perfect Correlation)** | `0.499478` | `-11.26 dB` | `0.074893` |
| **H_ls_attention (ONNX Attention Model with LS Sequence Input)** | `0.499990` | `-5.84 dB` | `0.260631` |
