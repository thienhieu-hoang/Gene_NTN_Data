...
| :--- | :---: | :---: | :---: |
| **LS + Linear Interpolation (LI Benchmark)** | `0.496844` | `-10.71 dB` | `0.084872` |
| **LS + MMSE Benchmark (Perfect Correlation)** | `0.495379` | `-18.40 dB` | `0.014439` |
| **H_ls_attention (ONNX Attention Model with LS Sequence Input)** | `0.496619` | `-9.61 dB` | `0.109301` |
