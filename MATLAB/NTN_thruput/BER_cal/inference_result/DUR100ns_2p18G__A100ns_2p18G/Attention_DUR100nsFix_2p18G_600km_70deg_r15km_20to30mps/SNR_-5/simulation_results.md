...
| :--- | :---: | :---: | :---: |
| **LS + Linear Interpolation (LI Benchmark)** | `0.500533` | `8.19 dB` | `6.592846` |
| **LS + MMSE Benchmark (Perfect Correlation)** | `0.500608` | `-8.00 dB` | `0.158579` |
| **H_ls_attention (ONNX Attention Model with LS Sequence Input)** | `0.500667` | `-3.71 dB` | `0.425202` |
