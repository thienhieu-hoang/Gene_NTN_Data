function [H, H_time] = nrPerfectChannelEstimate_custom2(varargin)
...
%#codegen
    ...
    N = N(1);
    % N = N - mod(N,ofdminfo.SymbolsPerSlot); % original - if num_slot>1 (N>14)
                                            % set this value to smaller,
                                            % multiple of 14
    if mod(N,ofdminfo.SymbolsPerSlot) % edited
        N = N - mod(N,ofdminfo.SymbolsPerSlot) + 14; 
    end
