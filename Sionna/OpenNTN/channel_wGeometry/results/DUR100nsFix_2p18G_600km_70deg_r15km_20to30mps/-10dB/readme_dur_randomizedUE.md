...
- **Average RMS Delay Spread (Realized)**: 80.36 ns (Range: [38.44, 202.83] ns)
...
- **UE Farthest from Satellite (Min Elevation)**: 68.45°
- **UE Closest to Satellite (Max Elevation)**: 70.57°
- **Average Across All UEs (Mean Elevation)**: 69.61°
