...
- **Average RMS Delay Spread (Realized)**: 480.88 ns (Range: [0.00, 63362.12] ns)
...
- **UE Farthest from Satellite (Min Elevation)**: 49.56°
- **UE Closest to Satellite (Max Elevation)**: 51.49°
- **Average Across All UEs (Mean Elevation)**: 50.52°
