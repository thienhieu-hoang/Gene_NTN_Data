# Channel & Geometry Generation Settings - URB (Randomized UE)

- **Scenario Type**: URB (dur = Dense Urban, sur = SubUrban, urb = Urban)
...
- **Average RMS Delay Spread (Realized)**: 90.63 ns (Range: [5.30, 449.58] ns)
