...
- **Target Delay Spread Configuration**: 300.0 ns (Custom Overridden)
- **Average RMS Delay Spread (Realized)**: 277.18 ns (Range: [97.37, 632.72] ns)
